...
//	private boolean mTestDelayElapsed; // add a timer for testing
	...
	public void onCreate() {
		...
		Bitmap bm = null;
		try {
			bm = BitmapFactory.decodeResource(getResources(), R.drawable.tb72_72);
		} catch (Exception e) {
		}
//		mNotif = Compatibility.createNotification(this, mNotificationTitle, "", R.drawable.status_level, IC_LEVEL_OFFLINE, bm, mNotifContentIntent, true);
		mNotif = Compatibility.createNotification(this, mNotificationTitle, "", R.drawable.tb72_72, IC_LEVEL_OFFLINE, bm, mNotifContentIntent, true);
...
//		mNotif = Compatibility.createNotification(this, mNotificationTitle, text, R.drawable.status_level, level, bm, mNotifContentIntent, true); 
		mNotif = Compatibility.createNotification(this, mNotificationTitle, text, R.drawable.tb72_72, level, bm, mNotifContentIntent, true);
